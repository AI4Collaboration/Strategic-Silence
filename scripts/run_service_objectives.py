...
def prepare(parent,out):
    ...
    design=[dict(model=pilot.MODEL,case=asdict(pilot.old.base.Case(('factory','pipeline')[i%2],609500+i,'split')),
    ...
    cfg.update(protocol='service_objectives_v1',design=design,
        ...
        primary='Compare useful-information gaps by aligned/mixed/competitive within each of three matched cases. Fixed per_call mechanics. Report all invalids, ties and reversals; no pooling with contract experiments.')
...
Primary unit: matched case triplet. Review actual message and document sufficiency before comparing information-gap fractions across conditions. Record ties/reversals and invalids. Three cases are exploratory. No replacements or outcome-based stopping; stop only on provider or budget failure. Prior $5 total cap and failed reservations retained. Separate cohort from earlier contract experiment. No Kimi runs in this batch.
""")
    return cfg
