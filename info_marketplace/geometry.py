...
class Geometry:
    ...
    def action_grammar(self) -> str:
        return """  MOVE Forest | MOVE River | MOVE Plains | MOVE Mines
  GATHER food | GATHER water | GATHER gold
  DEPOSIT food <integer> | DEPOSIT water <integer>
  TRADE food|water|gold <integer> FOR food|water|gold <integer> WITH Agent_0|Agent_1|Agent_2|Agent_3
  STAY"""

    def action_examples(self) -> str:
        """Concrete one-action choices for the per-turn user prompt."""
        return (
            "MOVE Forest | MOVE River | MOVE Plains | MOVE Mines | "
            "GATHER food | GATHER water | GATHER gold | "
            "DEPOSIT food 1 | DEPOSIT water 1 | "
            "TRADE food 1 FOR water 1 WITH Agent_0 | STAY"
        )
...
agent. What others cannot see is your inventory and your intentions."""
    ...
    def action_grammar(self) -> str:
        return """  GATHER food | GATHER water | GATHER gold
  DEPOSIT food <integer> | DEPOSIT water <integer>
  TRADE food|water|gold <integer> FOR food|water|gold <integer> WITH Agent_0|Agent_1|Agent_2|Agent_3
  STAY"""
