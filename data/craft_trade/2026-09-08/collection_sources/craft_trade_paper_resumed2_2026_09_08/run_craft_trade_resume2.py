...
ROOT=runner.ROOT
PRIOR=[ROOT/'results'/name for name in ('craft_trade_paper_v2_2026_09_08','craft_trade_paper_overnight_2026_09_08','craft_trade_paper_resumed_2026_09_08')]
OUT=ROOT/'results/craft_trade_paper_resumed2_2026_09_08'
...
def main():
 with ExitStack() as stack:
  ...
  (OUT/'sources/run_craft_trade_resume2.py').write_bytes(__import__('pathlib').Path(__file__).read_bytes())
